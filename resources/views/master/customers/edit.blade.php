...
@section('dashboard-content')
    ...
    <div class="card rounded-4 w-100 m-0">
        <form action="{{ route('master_customers.update', $customer->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="card-footer d-flex justify-content-between align-items-center">
                <a href="{{ route('master_customers.index') }}" class="btn btn-sm rounded-4 btn-secondary">Batal <i

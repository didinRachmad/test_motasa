...
@section('dashboard-content')
    ...
    <form action="{{ route('transaksi_sales_orders.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card rounded-4 w-100 m-0">
            ...
            <div class="card-footer d-flex justify-content-between align-items-center">
                <a href="{{ route('transaksi_sales_orders.index') }}" class="btn btn-sm rounded-4 btn-secondary">

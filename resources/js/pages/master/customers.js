...
export default {
    initIndex() {
        console.log("Halaman Customers Index berhasil dimuat!");
        let table;
        table = $("#datatables");
        ...
        table = table.DataTable({
            ...
            columns: [
                ...
                { data: "tipe_outlet", name: "tipe_outlet" },
                {
                    data: null,
                    orderable: false,
                    searchable: false,
    ...
    initShow() {
        console.log("Halaman Customers Show berhasil dimuat!");
    },
    initCreate() {
        console.log("Halaman Customers Create berhasil dimuat!");
    },
    initEdit() {
        console.log("Halaman Customers Edit berhasil dimuat!");
    },
};
